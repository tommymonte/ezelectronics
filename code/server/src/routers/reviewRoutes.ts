...
class ReviewRoutes {
	...
	initRoutes() {
		 ...
		 * It expects a product model as a route parameter.
		 * This parameter must be a non-empty string and the product must exist.
		 * The user must also have made a review for the product
		 * It returns a 200 status code.
		 */
		this.router.delete(
			'/:model',
